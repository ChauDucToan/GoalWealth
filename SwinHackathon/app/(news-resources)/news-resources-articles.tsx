    ...
    <SafeAreaView style={[styles.root, { backgroundColor: colors.backgroundSoft }]} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.headerRow}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text }]}>Our Articles</Text>
        ...
        {contentFeed.map((item) => (
          <Pressable
            ...
            onPress={() => router.push('/news-resources-article-detail')}
          >
            ...
            <MaterialIcons name="chevron-right" size={20} color={hexToRgba(colors.text, 0.4)} />
          </Pressable>
        ))}
      </ScrollView>
      <SupportBubble />
